...
image:https://travis-ci.org/Christoph-D/latex-unicode-math-mode.svg?branch=master["Build Status",link="https://travis-ci.org/Christoph-D/latex-unicode-math-mode"]
